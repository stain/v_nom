...
/**
   Parse the filestem for this class.

   The current token is the 'filestem' keyword.

   FS:= G_TOKEN_SYMBOL '=' G_TOKEN_IDENTIFIER ';'
 */
  ...
  if(!matchNext(G_TOKEN_IDENTIFIER))
    {
      g_scanner_unexp_token(gScanner,
                            ...
                            NULL,
                            NULL,
                            "Filestem is not a valid identifier.",
                            TRUE); /* is_error */
      exit(1);
    }
